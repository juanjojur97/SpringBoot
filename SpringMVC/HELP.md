...
* The original package name 'com.juanjojur.curso.springboot.webapp.springboot-web' is invalid and this project uses 'com.juanjojur.curso.springboot.webapp.springbootweb' instead.
