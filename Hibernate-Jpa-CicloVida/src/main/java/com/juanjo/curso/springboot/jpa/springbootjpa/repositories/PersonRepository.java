package com.juanjo.curso.springboot.jpa.springbootjpa.repositories;
...
//    List<String> findAllFullNameConcat();
    ...
    List <Long> findAllProgrammingLanguageDistinctCount();
    ...
    @Query("select new com.juanjo.curso.springboot.jpa.springbootjpa.dto.PersonDto(p.name, p.lastname) from Person p")
